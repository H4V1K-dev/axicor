...
impl PingPongSchedule {
    pub unsafe fn new(batch_ticks: usize, max_spikes_per_tick: usize, is_sleeping: Arc<AtomicBool>) -> Self {
        ...
        let s = Self {
            buffer_a: genesis_compute::ffi::gpu_host_alloc(buf_size) as *mut u32,
            buffer_b: genesis_compute::ffi::gpu_host_alloc(buf_size) as *mut u32,
            counts_a: genesis_compute::ffi::gpu_host_alloc(counts_size) as *mut u32,
            counts_b: genesis_compute::ffi::gpu_host_alloc(counts_size) as *mut u32,
