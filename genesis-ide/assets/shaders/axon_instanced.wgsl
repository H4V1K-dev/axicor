...
// Декодирование PackedPosition (X:11, Y:11, Z:6, Type:4)
// Voxel size = 25.0 um
...
fn vertex(vertex: Vertex) -> VertexOutput {
    ...
    // Защита от деления на 0 (self-loop)
    if length_val < 0.001 {
    ...
    let up = dir / length_val; // Нормализованное направление (новая ось Y)
    ...
    // Масштабируем цилиндр: радиус 0.15 um, высота = length
    ...
    // Сдвигаем в центр (цилиндр Bevy центрирован в 0, сдвигаем на start + dir/2)
