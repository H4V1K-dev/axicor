...
Запустите обучающегося агента за четыре команды и смотрите как муравей бродит вокруг спавна.
...
Ты увидишь как Score упирается в рамки эпизода, синапсы прунятся и сеть адаптируется в реальном времени.
